...
const PdfUpload = () => {
  ...
  const sendAdminNotification = async (doc) => {
    ...
    const emailBody = `A new document "${pdfName}" has been uploaded for approval. It is for ${pdfDescription} in ${subCategory} of ${category}. Please review it: <a href="http://10.10.1.80:5173/homeAdmin">Click Here</a>.<br><br>Note: Please check before approving.`;
